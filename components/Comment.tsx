import { ICommentsDocument } from '@/models/comment.model'
import React from 'react'
import ProfilePhoto from './shared/ProfilePhoto'
import ReactTimeago from 'react-timeago'

const Comment = ({ comment }: { comment: ICommentsDocument }) => {
    return (
        <div className='flex gap-2 my-4'>
            ...
            <div className='flex flex-1 justify-between p-3 bg-[#F2F2F2]'>
                <div>
                    ...
                    <p className='tex-xm text-gray-500'>@{comment?.user?.userName}</p>
